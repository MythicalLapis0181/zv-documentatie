...
| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Zilverveld |
| Officiële naam            | Algemeen Wetboek Zilverveld |
| Citeertitel               | Wetboek Zilverveld |
...
1. Het Wetboek Zilverveld (verder aangeduid als WTDA) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WTDA heeft betrekking op het vaste land, de gemeente, en de stad Zilverveld.
3. Het WTDA is nauw verweven met de Algemene Plaatselijke Verordening Zilverveld (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Zilverveld op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Zilverveld niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Zilverveld waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding met uitzondering zoals beschreven in lid E van dit artikel;
...
---------------------
*Wetboek Zilverveld is opgesteld uit naam van de beheerders, bedoeld voor de gemeente en de stad “Zilverveld”, opgetekend door Bram Mosterdfiets, te Zilverveld.*