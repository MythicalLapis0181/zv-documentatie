...
1. Het Wetboek Zilverveld (verder aangeduid als WZV) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WZV heeft betrekking op het vaste land, de gemeente, en de stad Zilverveld.
3. Het WZV is nauw verweven met de Algemene Plaatselijke Verordening Zilverveld (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
